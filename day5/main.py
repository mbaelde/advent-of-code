...
light_to_temperature_map = light_to_temperature_range_map.generate_map(
    min_seed, max_seed
)
...
temperature_to_humidity_map = temperature_to_humidity_range_map.generate_map(
    min_seed, max_seed
)
...
humidity_to_location_map = humidity_to_location_range_map.generate_map(
    min_seed, max_seed
)

seeds_locations = {
    seed: humidity_to_location_map[
        temperature_to_humidity_map[
            light_to_temperature_map[
                water_to_light_map[
                    fertilizer_to_water_map[
                        soil_to_fertilizer_map[seed_to_soil_map[seed]]
                    ]
                ]
            ]
        ]
